...
# -- clean log/dont display warnings
...
class SAGAN(object):
    ...
    def __init__(self, sess, args):
        ...
        print("# dataset size : ", self.dataset_num)
    ...
    def generator(self, z, is_training=True, reuse=False):
        with tf.variable_scope("generator", reuse=reuse):
           ...
           # x = up_resblock(x, channels=ch, is_training=is_training, sn=self.sn, scope='extra_resblock_0')
