...
# -- clear the log of all deprecated/data type/etc warnings
import warnings
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='colab_resized_landscape', help='[colab_resized_landscape]')

    parser.add_argument('--epoch', type=int, default=1, help='The number of epochs to run') #--10 default
    parser.add_argument('--iteration', type=int, default=1, help='The number of training iterations') #--10000 default
    ...
    parser.add_argument('--sample_num', type=int, default=32, help='The number of sample images')
